            ...
            <div style={{ marginBottom: 14 }}>
              <button
                ...
                style={{
                  ...
                  padding: '8px 12px',
                  borderRadius: 10,
                  border: showWaPreview ? `1.5px solid ${C.success}` : '1.5px solid #e0e0e0',
                  background: showWaPreview ? '#f0fdf4' : '#f9f9f9',
                  fontFamily: 'Poppins',
                  fontSize: 12,
                  fontWeight: 500,
                  color: showWaPreview ? C.success : C.n700,
                  cursor: 'pointer',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: 6,
                  marginBottom: showWaPreview ? 12 : 0,
                }}
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill={showWaPreview ? C.success : '#555'}>
                ...
                {showWaPreview ? 'Sembunyikan Preview' : 'Lihat Preview Chat WA'}
              </button>
              ...
              {showWaPreview && (
                <WhatsAppChatPreview
                  variables={{
                    ...
                    transactionNo: tx?.transactionNo || tx?.id || '-',
                    customerPhone: tx?.customerPhone,
                    pickupType: tx?.pickupType,
                    pickupScheduleAt: tx?.pickupScheduleAt,
                    outletName: tx?.outletName || 'Wäschen Laundry',
