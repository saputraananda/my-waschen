...
import { getMe, getAllUsers, getPICUsers, registerUser, toggleUser, updateMyProfile, changeMyPassword, updateUser, deleteUser, getMyActivities } from '../controllers/userController.js';
...
router.get('/pic',                authenticate, getPICUsers);
